    ...
    >
      <div className="w-full flex justify-between items-center px-8 pt-4 pb-3 text-white font-oxygen duration-150">
        <a href="#hero" data-aos="fade-down" data-aos-delay="50">
          <img src={Logo} alt="Logo" className="w-16" onClick={onClick} />
        </a>
        <ul className="hidden md:flex items-start gap-8">
          ...
          <a
            ...
            data-aos-delay="50"
          >
            <li className="hover:text-accent hover:cursor-pointer">O mnie</li>
          </a>
          <a
            href="#my-projects"
            onClick={onClick}
          ...
          <a
            ...
            data-aos-delay="50"
          >
            <li className="hover:text-accent hover:cursor-pointer">Kontakt</li>
          </a>
        </ul>
      </div>
      <div className="block md:hidden">
        <Menu right>
          ...
          <a href="#my-projects" onClick={onClick} data-aos="fade-down">
            <li className="hover:text-accent hover:cursor-pointer">
              Moje projekty
            </li>
          </a>
